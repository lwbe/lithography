    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_1', models.FloatField(blank=True, default='', null=True, verbose_name='Second parameter')),
                ('value_2', models.FloatField(blank=True, default='', null=True, verbose_name='Third parameter')),
                ('value_3', models.FloatField(blank=True, default='', null=True, verbose_name='Fourth parameter')),
                ('value_4', models.FloatField(blank=True, default='', null=True, verbose_name='Fifth parameter')),
                ('value_5', models.FloatField(blank=True, default='', null=True, verbose_name='Sixth parameter')),
                ('value_6', models.FloatField(blank=True, default='', null=True, verbose_name='Seventh parameter')),
                ('value_7', models.FloatField(blank=True, default='', null=True, verbose_name='Eight parameter')),
                ('value_8', models.FloatField(blank=True, default='', null=True, verbose_name='Ninth parameter')),
                ('value_9', models.FloatField(blank=True, default='', null=True, verbose_name='Tenth parameter')),
            ],
        ),
        migrations.CreateModel(
            name='MotifType',
            fields=[
                ...
                ('param_name_1', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_2', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_3', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_4', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_5', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_6', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_7', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_8', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('param_name_9', models.CharField(blank=True, default='', max_length=255, null=True)),
